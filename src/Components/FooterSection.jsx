      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
          <div className="flex-1 mb-6 md:mb-0">
            ...
            <p className="mb-0 text-base">जिल्हा: सोलापूर <br/>तालुका: अक्कलकोट <br/>राज्य: महाराष्ट्र</p>
          </div>
          <div className="flex-1 mb-6 md:mb-0">
            ...
            <ul className="space-y-2 text-base">
              <li className="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><rect x="2" y="7" width="20" height="10" rx="2" /><polyline points="2,7 12,13 22,7" /></svg>grampabchayatshirwal1951@gmail.com</li>
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="https://www.zpsolapur.gov.in/" target="_blank" className="text-white hover:underline flex items-center gap-1"><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M18 13v6a2 2 0 01-2 2H8a2 2 0 01-2-2v-6"/><path d="M15 10l5-5m0 0l-5-5m5 5H9"/></svg>जिल्हा परिषद सोलापूर </a>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="mb-0">&copy; 2025 Developed by <span className="font-bold">SDG INFOWEB</span></p>
